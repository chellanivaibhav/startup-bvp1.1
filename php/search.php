				...
				<div class="dropdownbox1"><!--distance dropdown box it is  -->
					<div class="dropdown">
						<select name="Distance">
							<option value="3" <?php if ($_POST["Distance"]=='3') echo ' selected="selected"'; ?>>1-3 km </option>
							<option value="5" <?php if ($_POST["Distance"]=='5') echo ' selected="selected"'; ?>>3-5 km</option>
							<option value="7"<?php if ($_POST["Distance"]=='7') echo ' selected="selected"'; ?> >5-7 km</option>

						</select>
					</div>
					<div class="dropdown">
						<select name="Gender">
							<option value="Any" <?php if ($_POST["Gender"]=='Any') echo ' selected="selected"'; ?>
								>Any</option>
